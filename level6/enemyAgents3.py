...
class MoveToTarget(State):
	...
	def enter(self, oldstate):
		self.agent.navigateTo((self.agent.world.dimensions[0]/10, self.agent.world.dimensions[1]*9/10))


	def execute(self, delta = 0):

		target = (self.agent.world.dimensions[0]/10, self.agent.world.dimensions[1]*9/10)
